...
![특성 중요도](results/feature_importance.png)
...
![초과적합 시각화](results/ultra_overfitting.png)
...
![기본 모델 분포](results/basic_model.png)
...
![예측 Top 20](results/predictions.png)

상위 20개 품목 쌍의 예측값 시각화

### 3. 모델 비교

![6개 모델 비교](results/model_comparison.png)

5개 모델 + 베이스라인의 성능 비교

### 4. 고급 특성 분석

![고급 특성 중요도](results/advanced_features.png)

28개 고급 특성의 중요도 분석 (모델 2)

### 5. 과적합 분석

![과적합 시각화](results/ultra_overfitting.png)
